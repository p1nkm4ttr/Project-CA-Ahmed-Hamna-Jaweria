...
module addressDecoderTop(
    ...
    // Finds the HIGHEST set switch bit and returns 2^index (binary representation)
    // switch 0 -> 1, switch 1 -> 2, switch 2 -> 4, ..., switch 15 -> 32768
    ...
    always @(*) begin
        ...
        for (i = 0; i < 16; i = i + 1) begin
            if (switches[i])
                switch_encoded = (32'd1 << i);  // 2^i; overwrites with higher indices
        end
    end
