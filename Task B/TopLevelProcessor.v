...
module TopLevelProcessor(
    ...
    //   BGE  (funct3=101): branch when Less_Than=0 (i.e. rs1 >= rs2)
    ...
    wire bge_taken = ( instruction[14]) & ( instruction[12]) & (~Less_Than);// funct3=101
    wire branch_taken = Branch & (beq_taken | bne_taken | blt_taken | bge_taken);
